...
declare class SDK {
     ...
     */
    createImageToVideoGeneration(body: types.CreateImageToVideoGenerationBodyParam): Promise<FetchResponse<200, types.CreateImageToVideoGenerationResponse200>>;
    /**
     * This endpoint will generate a video using a text prompt
     *
     * @summary Create a video generation from a text prompt
     */
    createTextToVideoGeneration(body: types.CreateTextToVideoGenerationBodyParam): Promise<FetchResponse<200, types.CreateTextToVideoGenerationResponse200>>;
    /**
     * This endpoint will upscale a generated video to a higher resolution.
     *
     * @summary Upscale a generated video
     */
    createVideoUpscale(body: types.CreateVideoUpscaleBodyParam): Promise<FetchResponse<200, types.CreateVideoUpscaleResponse200>>;
    /**
     ...
     */
    getMotionVariationById(metadata: types.GetMotionVariationByIdMetadataParam): Promise<FetchResponse<200, types.GetMotionVariationByIdResponse200>>;
    /**
