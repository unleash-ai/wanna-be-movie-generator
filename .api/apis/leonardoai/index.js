...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.core = new core_1.default(this.spec, 'leonardoai/v1.0.0 (api/6.1.3)');
    }
    /**
     ...
     */
    SDK.prototype.createImageToVideoGeneration = function (body) {
     ...
     */
    SDK.prototype.createTextToVideoGeneration = function (body) {
     ...
     */
    SDK.prototype.createVideoUpscale = function (body) {
     ...
     */
    SDK.prototype.getMotionVariationById = function (metadata) {
     ...
     */
    SDK.prototype.getCustomModelsByUserId = function (metadata) {
     ...
     */
    SDK.prototype.getElementById = function (metadata) {
     ...
     */
    SDK.prototype.deleteElementById = function (metadata) {
     ...
     */
    SDK.prototype.getCustomElementsByUserId = function (metadata) {
     ...
     */
    SDK.prototype.createElement = function (body) {
